...
$$
L=\sum_{\alpha}(\frac{m_\alpha c^2}{\sqrt{1-v_\alpha^2/c^2}}-q_\alpha \phi(x_\alpha,t)+q_\alpha A^i(x_\alpha,t)v_i)
$$
在Lorenz规范下我们有
$$
...
$$
$$
\implies R=R_0+\frac{v_\beta\cdot R_0}{c}+\frac{(v_\beta \cdot R_0)^2}{2 c^2 R_0}-\frac{(a_\beta \cdot R_0)R_0^2+v_\beta^2 R_0^2-(v_\beta \cdot R_0)^2}{2c^2 R_0}+o(\frac{1}{c^2})
$$
对于分母上的第二项我们只需展开到一阶
$$
...
综上,分母的二阶展开为
$$
R_0+\frac{v_\beta^2}{2c^2}R_0+\frac{(v_\beta\cdot R_0)^2}{c^2 R_0}+\frac{(a_\beta \cdot R_0)R_0}{2c^2}+o(\frac{1}{c^2})
$$
这给出了电势能的展开
$$
-q_\alpha \phi_\alpha(x_\alpha,t)=-\sum_\beta \frac{q_\alpha q_\beta}{4\pi \epsilon_0 R_{\alpha \beta}}(1-\frac{v_\beta^2}{c^2}+\frac{(v_\beta\cdot \hat{R}_{\alpha\beta})^2}{2c^2}-\frac{a_\beta \cdot R_{\alpha\beta}}{2c^2})+o(\frac{1}{c^2})
$$
由于磁矢势本身就是二阶的,因此无需展开.
结合动能,最终的展开形式为
$$
\begin{aligned}
L=\sum_{\alpha}m_\alpha c^2+\frac{m_\alpha v_\alpha^2}{2}+\frac{3m_\alpha v_\alpha^4}{4c^2}\\+\sum_{\alpha>\beta}\frac{q_\alpha q_\beta}{4\pi \epsilon_0 R_{\alpha \beta}}\left\{ -1+\frac{v_\alpha\cdot v_\beta}{c^2}+\frac{v_\beta^2}{c^2}\right\}
\end{aligned}
$$